			...
			<div className="pt-[180px] pb-[220px] items-center flex flex-col gap-[30px] ">
				...
				<form onSubmit={handleSearch} className="flex flex-col gap-[10px]">
					<TextField
						...
						className="w-[253px] text-center xl:w-[350px]"
					/>
					<BlueButton type="submit" className="w-[253px] xl:w-[350px]">
						Buscar
					</BlueButton>
				</form>
			</div>
			<div className="pt-[50px] pb-[130px] bg-[var(--fucsia-A200)] flex flex-col gap-[50px] items-center xl:bg-[var(--celeste-A100)]">
				<SubTitle>Productos Destacados</SubTitle>
				<div className="flex flex-col gap-[20px] items-center xl:flex-row xl:gap-[50px]">
					<Card
