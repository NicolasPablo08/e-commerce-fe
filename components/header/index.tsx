...
export function Header() {
	...
	return (
		<header className="w-[100%] h-[84px] bg-[black] ">
			<div className="px-[20px] flex justify-between items-center w-[100%] h-[100%] relative xl:px-[60px]">
				<Link href="/">
				...
				{isLoggedIn ? (
					...
					<FucsiaButton onClick={() => router.push("/signin")}>
						Ingresar
					</FucsiaButton>
				)}
			</div>
			{menuOpen && isLoggedIn && (
				<div className="bg-[black] text-[white] z-2 absolute top-[0] right-[0] w-[100%] h-screen flex flex-col justify-between pt-[50px] pb-[120px] align-center">
					...
					<div className="flex flex-col gap-[15px] text-center">
						...
						<LargeText
							className="text-[var(--fucsia-A200)]"
